...
class BinaryIn {
  ...
  static readString(str, width = 8) {
    BinaryIn.inData = str;
    let _str = "";
    while (!BinaryIn.isEmpty()) {
      _str += String.fromCharCode(BinaryIn.readInt(width));
    }
    return _str;
  }
  static fillBuffer() {
...
class LZW {
  static charWidth = 8;
  static charCount = Math.pow(2, LZW.charWidth);
  ...
  static compress(str) {
    ...
    let _str = BinaryIn.readString(str, LZW.charWidth);
  ...
  static expand(str) {
    ...
    while (true) {
      invariant(preChar != null, "Maybe the data is not generated by this program");
      BinaryOut.writeString(preChar, LZW.charWidth);
      ...
      if (shift < LZW.codewordsCount) {
        if (shift === codewords) {
          ...
          invariant(table[codewords] != null, "Maybe the data is not generated by this program");
